...
*/
  ...
  */
  ...
  /**
  * Gets the auto-create-queue value from the configuration.
  * Attribute Name: auto-create-queue
  * Description: 
  * Mandatory: yes
  * @return the auto-create-queue
  */
  public Boolean getAutoCreateQueue() {
    return config.getOptionalValue("auto-create-queue", Boolean.class)
        .orElseThrow(() -> new IllegalArgumentException("The attribute `auto-create-queue` on connector 'smallrye-rabbitmq' (channel: " + getChannel() + ") must be set"));
  }
